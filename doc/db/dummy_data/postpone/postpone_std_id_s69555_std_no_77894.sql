...
/* Test case for student stdno: 138179 */
DELETE FROM T_REG_POSTPONE
WHERE
	STDNO= 138179
	AND STDSTATCD = 155896
	AND FROMCCYRCD = 2018
	AND FROMSEMCD = 4;
	
	
Insert into SCHED_STD (STDNO,L_ABR_CRSNO,CRSNO,CRSTYPCD,SECTCD,SECTNO,HODAPROVALCD,CONDREGCD,ADVISAPROVALCD,AUDITFLAGCD,GRADECD,USRACCTCD) values (138179,'MASF8001',16694,38,207373,10,2,2,1,2,20,'s117777');

DELETE TUITION_FEES_STD WHERE STDNO=138179 AND L_ABR_CRSNO='MASF8001' AND SECTCD=207373;
